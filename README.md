...
📊 How It Works
User uploads an image of a single food item.

Image is preprocessed and passed to YOLO model.

Model returns predicted class name + confidence score.

App looks up nutrition data from nutrition_data.csv.

User adjusts portion size (in grams) using a slider.

Nutritional values are scaled proportionally.

The entry is added to the session's Daily Food Log.

Charts and insights are updated automatically.
...
🙌 Acknowledgements
Ultralytics YOLO for the awesome detection framework

Streamlit for making ML apps ridiculously easy
...
👩‍💻 Author
Srishti Kumari
www.linkedin.com/in/srishti-kumari-335b67252
(https://github.com/Srishtikumari510)
💬 Connect & Support
